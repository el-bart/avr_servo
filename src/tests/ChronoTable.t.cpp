...
{
  check(et()[0], 200, 0b11000000, 0b11000000, 0b00000011);
  checkEnd(et(), 1);
}
...
void testObj::test<2>(void)
{
  ...
  check(et()[1], 200, 0b11001000, 0b11000000, 0b00000011);
  checkEnd(et(), 2);
}
...
void testObj::test<3>(void)
{
  ...
  check(et()[1], 200, 0b11000010, 0b11000100, 0b00000011);
...
void testObj::test<4>(void)
{
  ...
  check(et()[12], 22, 0b11111111, 0b11111111, 0b11111011);
  check(et()[13], 23, 0b11111111, 0b11111111, 0b11110111);
  check(et()[14], 24, 0b11111111, 0b11111111, 0b11101111);
  check(et()[15], 25, 0b11111111, 0b11111111, 0b11011111);
